...
public class UsuarioOrganizacion  implements Versionable,Seleccionable,Identificable,Fillable,Cleanable,Auditable,java.io.Serializable {
    ...
    public UsuarioOrganizacion(Organizacion organizacionByIdSede, Usuario usuario, Organizacion organizacionByIdOrganizacion) {
        this.organizacionByIdSede = organizacionByIdSede;
        this.usuario = usuario;
        this.organizacionByIdOrganizacion = organizacionByIdOrganizacion;
    }
    public UsuarioOrganizacion(Organizacion organizacionByIdSede, Persona persona, Usuario usuario, Organizacion organizacionByIdSedeDefault, Organizacion organizacionByIdOrganizacion, String usuarioCreacion, LocalDateTime fechaCreacion, String usuarioModificacion, LocalDateTime fechaModificacion) {
       this.organizacionByIdSede = organizacionByIdSede;
