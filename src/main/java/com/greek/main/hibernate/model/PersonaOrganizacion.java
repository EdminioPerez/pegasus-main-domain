...
@Table(
        name = "persona_organizacion",
        schema = "public",
        uniqueConstraints =
                @UniqueConstraint(
                        columnNames = {"id_persona", "id_organizacion", "id_categoria_persona"}))
public class PersonaOrganizacion
    ...
    public PersonaOrganizacion(
            CategoriaPersona categoriaPersona, Persona persona, Organizacion organizacion) {
    ...
    @GenericGenerator(
            name = "persona_organizacion_seq_gen",
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof PersonaOrganizacion)) return false;
    ...
    public void cleanPOJO() {
        ...
        if (this.categoriaPersona != null
                && (categoriaPersona.getId() == null
                        || this.categoriaPersona.getId().longValue() == 0)) {
