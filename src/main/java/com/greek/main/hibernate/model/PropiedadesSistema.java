...
/**
 * PropiedadesSistema generated by hbm2java
 */
@Entity
...
public class PropiedadesSistema  implements Versionable,Seleccionable,Identificable,Fillable,Cleanable,Auditable,java.io.Serializable {
    ...
    public PropiedadesSistema(String propiedad, String valor) {
        this.propiedad = propiedad;
        this.valor = valor;
    }
    public PropiedadesSistema(Organizacion organizacion, String propiedad, String valor, String usuarioCreacion, LocalDateTime fechaCreacion, String usuarioModificacion, LocalDateTime fechaModificacion) {
  ...
  @GenericGenerator(name = "propiedades_sistema_seq_gen", strategy = "org.hibernate.id.enhanced.SequenceStyleGenerator",
            parameters = {
                    @Parameter(name = "sequence_name", value = "propiedades_sistema_id_seq"),
                    @Parameter(name = "initial_value", value = "1"),
                    @Parameter(name = "increment_size", value = "1")
            })
  @GeneratedValue(generator = "propiedades_sistema_seq_gen")
  @Id
...
@ManyToOne(fetch=FetchType.LAZY)
     ...
     */
     ...
     public String toString() {
      ...
      buffer.append("propiedad").append("='").append(getPropiedad()).append("' ");			
      buffer.append("valor").append("='").append(getValor()).append("' ");			
	...
	public boolean equals(Object other) {
		 ...
		 if (!(other instanceof PropiedadesSistema)) 
		 	return false;
		 	
		 PropiedadesSistema castOther = ( PropiedadesSistema ) other; 
...
// Adding extra-code
    ...
    public PropiedadesSistema createPOJO() {
		fillPOJO();
